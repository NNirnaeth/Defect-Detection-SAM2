...
def eval(args):
    ...
    image_path =   'datasets/images/images/ID00110637202210673668310_175.jpg'
    mask_path =    'datasets/masks/masks/ID00110637202210673668310_mask_175.jpg'
...
if __name__ == "__main__":
    ...
    if args.mode == "train":
        ...
        if not args.fine_tuned_checkpoint:
            parser.error("You must provide --fine_tuned_checkpoint for evaluation mode.")
        eval(args)

    # Visualize data (adjust `train_data`)
